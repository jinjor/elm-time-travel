...
var _user$project$TimeTravel_Internal_Model$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {future: a, history: b, filter: c, sync: d, expand: e, msgId: f, selectedMsg: g, showDiff: h, fixedToLeft: i};
	});
...
var _user$project$TimeTravel_Internal_Styles$normalLine = A2(
	_elm_lang$core$Basics_ops['++'],
	_elm_lang$core$Native_List.fromArray(
		[]),
...
var _user$project$TimeTravel_Internal_Styles$zIndex = {debugView: '2147483647', resyncView: '2147483646'};
...
var _user$project$TimeTravel_Internal_Parser_Formatter$formatListLike = F5(
	function (indent, wordsLimit, start, end, list) {
		var _p0 = list;
		if (_p0.ctor === '::') {
			var _p1 = _p0._0;
			var tailStr = A2(
		...
		switch (_p2.ctor) {
			...
			case 'Union':
				...
				var tailStr = A2(
					...
					_p5);
				var joinedTailStr = A2(_elm_lang$core$String$join, '', tailStr);
				var multiLine = A2(_elm_lang$core$String$contains, '\n', joinedTailStr) || (_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$String$length(
						A2(_elm_lang$core$Basics_ops['++'], _p4, joinedTailStr)),
					c.wordsLimit) > 0);
				var s = multiLine ? A2(
					_elm_lang$core$String$join,
					'\n',
			...
			function (change) {
				...
				switch (_p0.ctor) {
					case 'NoChange':
						return A2(
							_elm_lang$core$List$map,
							_user$project$TimeTravel_Internal_DiffView$normalLine,
							_elm_lang$core$String$lines(_p0._0));
					case 'Changed':
						return A2(
							_elm_lang$core$Basics_ops['++'],
							A2(
								_elm_lang$core$List$map,
								_user$project$TimeTravel_Internal_DiffView$deletedLine,
								_elm_lang$core$String$lines(_p0._0)),
							A2(
								_elm_lang$core$List$map,
								_user$project$TimeTravel_Internal_DiffView$addedLine,
								_elm_lang$core$String$lines(_p0._1)));
					case 'Added':
						return A2(
							_elm_lang$core$List$map,
							_user$project$TimeTravel_Internal_DiffView$addedLine,
...
var _user$project$TimeTravel_Internal_DiffView$view = F2(
	function (oldAst, newAst) {
		return A2(
			...
			_user$project$TimeTravel_Internal_Parser_Formatter$formatAsString(oldAst),
			_user$project$TimeTravel_Internal_Parser_Formatter$formatAsString(newAst));
	});
...
var _user$project$TimeTravel_Internal_View$detailView = function (model) {
	if (_elm_lang$core$Basics$not(model.sync)) {
		var detailedMsgView = function () {
			var _p8 = _user$project$TimeTravel_Internal_Model$selectedMsgAst(model);
			if (_p8.ctor === 'Just') {
				return A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_user$project$TimeTravel_Internal_Parser_Formatter$formatAsString(_p8._0))
						]));
			} else {
		...
		var diffView = function () {
			var _p9 = _user$project$TimeTravel_Internal_Model$selectedAndOldAst(model);
			if (_p9.ctor === 'Just') {
				return A2(_user$project$TimeTravel_Internal_DiffView$view, _p9._0._0, _p9._0._1);
			} else {
				return _elm_lang$html$Html$text('');
			}
		}();
		var msgTreeView = function () {
			...
			if (((_p10.ctor === '_Tuple2') && (_p10._0.ctor === 'Just')) && (_p10._1.ctor === 'Just')) {
				return A3(_user$project$TimeTravel_Internal_MsgTreeView$view, _user$project$TimeTravel_Internal_Model$SelectMsg, _p10._0._0, _p10._1._0);
			} else {
				return _elm_lang$html$Html$text('');
			}
		}();
...
var _user$project$TimeTravel_Internal_View$modelView = function (model) {
	var _p11 = _user$project$TimeTravel_Internal_Model$selectedItem(model);
	if (_p11.ctor === 'Just') {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(_p11._0.model))
						]))
				]));
	} else {
		return _elm_lang$html$Html$text('');
...
var _user$project$TimeTravel_Internal_View$filterItemView = function (_p12) {
	var _p13 = _p12;
	var _p14 = _p13._0;
	return A2(
		_elm_lang$html$Html$div,
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$checked(_p13._1),
								_elm_lang$html$Html_Events$onClick(
								_user$project$TimeTravel_Internal_Model$ToggleFilter(_p14))
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$TimeTravel_Internal_View$modelView(model),
						A4(
