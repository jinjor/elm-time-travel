...
var _user$project$TimeTravel_Internal_Parser_Util$equal = _Bogdanp$elm_combine$Combine_Char$char(
	_elm_lang$core$Native_Utils.chr('='));
var _user$project$TimeTravel_Internal_Parser_Util$comma = _Bogdanp$elm_combine$Combine_Char$char(
	_elm_lang$core$Native_Utils.chr(','));
var _user$project$TimeTravel_Internal_Parser_Util$notEqual = _Bogdanp$elm_combine$Combine_Char$satisfy(
	F2(
		function (x, y) {
			return !_elm_lang$core$Native_Utils.eq(x, y);
		})(
...
var _user$project$TimeTravel_Internal_Parser_Util$manyChars = function ($char) {
	return A2(
		...
		_Bogdanp$elm_combine$Combine$many($char));
};
...
var _user$project$TimeTravel_Internal_Parser_Util$someChars = function ($char) {
	return A2(
		_Bogdanp$elm_combine$Combine$map,
		_elm_lang$core$String$fromList,
		_Bogdanp$elm_combine$Combine$many1($char));
};
...
var _user$project$TimeTravel_Internal_Parser_Util$noSpace = _Bogdanp$elm_combine$Combine_Char$satisfy(
	function (_p0) {
		return _elm_lang$core$Basics$not(
			_user$project$TimeTravel_Internal_Parser_Util$isSpace(_p0));
	});
var _user$project$TimeTravel_Internal_Parser_Util$space = _Bogdanp$elm_combine$Combine_Char$satisfy(_user$project$TimeTravel_Internal_Parser_Util$isSpace);
...
var _user$project$TimeTravel_Internal_Parser_Parser$propertyKey = _Bogdanp$elm_combine$Combine$rec(
	function (_p0) {
...
var _user$project$TimeTravel_Internal_Parser_Parser$tag = A2(
	...
	A2(
		...
		_Bogdanp$elm_combine$Combine_Char$upper),
	_Bogdanp$elm_combine$Combine$many(
		_Bogdanp$elm_combine$Combine_Char$satisfy(
			function (c) {
...
var _user$project$TimeTravel_Internal_Parser_Parser$function = A2(
	...
	A2(
		...
		A2(
			...
			_Bogdanp$elm_combine$Combine$string('<function')),
...
var _user$project$TimeTravel_Internal_Parser_Parser$floatLiteral = A2(
	...
	_Bogdanp$elm_combine$Combine_Num$float);
	...
	function (_p9) {
		return A2(
			...
			A2(
				...
				_user$project$TimeTravel_Internal_Parser_Parser$intLiteral),
