...
var _user$project$TimeTravel_Internal_Parser_Formatter$formatListLike = F4(
	function (indent, start, end, list) {
		var _p0 = list;
		if (_p0.ctor === '::') {
			var _p1 = _p0._0;
			var tailStr = A2(
			...
			var joinedStr = A2(
				_elm_lang$core$Basics_ops['++'],
				_p1,
				A2(_elm_lang$core$String$join, '', tailStr));
			return ((_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$String$length(joinedStr),
				80) > 0) || A2(_elm_lang$core$String$contains, '\n', joinedStr)) ? A2(
				...
				A2(
					...
					A2(_elm_lang$core$List$map, indent, tailStr))) : A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$Basics_ops['++'], start, _p1),
				A2(_elm_lang$core$String$join, '', tailStr));
		} else {
			return A2(_elm_lang$core$Basics_ops['++'], start, end);
		}
	});
var _user$project$TimeTravel_Internal_Parser_Formatter$indent = F2(
	function (context, s) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$String$repeat, context.nest, '  '),
			s);
	});
var _user$project$TimeTravel_Internal_Parser_Formatter$format = F2(
	function (c, ast) {
		var _p2 = ast;
		switch (_p2.ctor) {
			case 'Record':
				return A4(
					_user$project$TimeTravel_Internal_Parser_Formatter$formatListLike,
					_user$project$TimeTravel_Internal_Parser_Formatter$indent(c),
					'{',
					'}',
					A2(
						_elm_lang$core$List$map,
						_user$project$TimeTravel_Internal_Parser_Formatter$format(
							_elm_lang$core$Native_Utils.update(
								c,
								{nest: c.nest + 1})),
						_p2._0));
			case 'Property':
				...
				return A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						' = ',
						(A2(_elm_lang$core$String$contains, '\n', s) || (_elm_lang$core$Native_Utils.cmp(
			...
			case 'Union':
				...
				var s = multiLine ? A2(
					...
					_elm_lang$core$String$join,
					' ',
					A2(_elm_lang$core$List_ops['::'], _p4, tailStr));
				return (_elm_lang$core$Basics$not(
					_elm_lang$core$List$isEmpty(_p5)) && c.parens) ? A2(
					_elm_lang$core$Basics_ops['++'],
					'(',
					A2(
						_elm_lang$core$Basics_ops['++'],
						s,
						A2(_elm_lang$core$Debug$log, 'multiLine', multiLine) ? A2(
							_elm_lang$core$Basics_ops['++'],
							'\n',
							A2(_user$project$TimeTravel_Internal_Parser_Formatter$indent, c, ')')) : ')')) : s;
			case 'ListLiteral':
				return A4(
					_user$project$TimeTravel_Internal_Parser_Formatter$formatListLike,
					_user$project$TimeTravel_Internal_Parser_Formatter$indent(c),
...
var _user$project$TimeTravel_Internal_Parser_Formatter$formatAsString = function (ast) {
	return A2(
		_user$project$TimeTravel_Internal_Parser_Formatter$format,
		{nest: 0, parens: false},
		ast);
};
var _user$project$TimeTravel_Internal_Parser_Formatter$Context = F2(
	function (a, b) {
		return {nest: a, parens: b};
	});

var _user$project$Tests$complexString = '\n{ seed =\n    Seed\n      (Seed\n        (Seed\n          { state = State 20418 1\n          , next = <function:_elm_lang$core$Random$next>\n          , split = <function:_elm_lang$core$Random$split>\n          , range = <function:_elm_lang$core$Random$range>\n          }\n        )\n        (Seed\n          { state = State 52770 1\n          , next = <function:_elm_lang$core$Random$next>\n          , split = <function:_elm_lang$core$Random$split>\n          , range = <function:_elm_lang$core$Random$range>\n          }\n        )\n      )\n, visitDate = {}\n, user = Guest\n, pos = (8,79)\n, draggingContext = None\n, selectedEquipments = []\n, copiedEquipments = []\n, equipmentNameInput = { editingEquipment = Nothing }\n, gridSize = 8\n, selectorRect = Nothing\n, keys = { ctrl = False, shift = False }\n, editMode = Viewing\n, colorPalette = []\n, contextMenu = NoContextMenu\n, floorsInfo = []\n, floor =\n    { cursor = 0\n    , original =\n        { id = Nothing\n        , name = \"1F\"\n        , equipments = []\n        , width = 800\n        , height = 600\n        , realSize = Nothing\n        , imageSource = None\n        , $public = False\n        , update = Nothing\n        }\n    , commits = []\n    , update = <function>\n    , cursorDataCache =\n        { id = Nothing\n        , name = \"1F\"\n        , equipments = []\n        , width = 800\n        , height = 600\n        , realSize = Nothing\n        , imageSource = None\n        , $public = False\n        , update = Nothing\n        }\n    }\n, windowSize = (1105,859)\n, scale = { scaleDown = 0 }\n, offset = (35,35)\n, scaling = False\n, prototypes = { data = [], selected = 0 }\n, error = NoError\n, floorProperty =\n    { nameInput = \"1F\"\n    , realWidthInput = \"0\"\n    , realHeightInput = \"0\"\n    }\n, selectedResult = Nothing\n, personInfo = Dict.fromList []\n, diff = Nothing\n, candidates = []\n, url =\n    { floorId = \"\"\n    , query = Nothing\n    , personId = Nothing\n    , editMode = False\n    }\n, searchBox = { query = \"\", results = Nothing }\n, tab = SearchTab\n, listTest1 = [100000,100000,100000,100000,100000]\n, tupleTest1 = (100000,100000,100000,100000,100000)\n, listTest2 = [100000,100000,100000,100000,100000,100000,100000,100000,100000,100000,100000,100000]\n, tupleTest2 = (100000,100000,100000,100000,100000,100000,100000,100000,100000,100000,100000,100000)\n}\n';
var _user$project$Tests$testParseProperties = F2(
	function (s, ast) {
		return A2(
			_elm_community$elm_test$ElmTest$assertEqual,
			_elm_lang$core$Result$Ok(ast),
			A2(_Dandandan$parser$Parser$parse, _user$project$TimeTravel_Internal_Parser_Parser$properties, s));
	});
var _user$project$Tests$testParseProperty = F2(
	function (s, ast) {
		return A2(
			_elm_community$elm_test$ElmTest$assertEqual,
			_elm_lang$core$Result$Ok(ast),
			A2(_Dandandan$parser$Parser$parse, _user$project$TimeTravel_Internal_Parser_Parser$property, s));
	});
var _user$project$Tests$testParseTuple = F2(
	function (s, ast) {
		return A2(
			_elm_community$elm_test$ElmTest$assertEqual,
			_elm_lang$core$Result$Ok(ast),
			A2(_Dandandan$parser$Parser$parse, _user$project$TimeTravel_Internal_Parser_Parser$tupleLiteral, s));
	});
var _user$project$Tests$testParseList = F2(
	function (s, ast) {
		return A2(
			_elm_community$elm_test$ElmTest$assertEqual,
			_elm_lang$core$Result$Ok(ast),
			A2(_Dandandan$parser$Parser$parse, _user$project$TimeTravel_Internal_Parser_Parser$listLiteral, s));
	});
var _user$project$Tests$testParseRecord = F2(
	function (s, ast) {
		return A2(
			_elm_community$elm_test$ElmTest$assertEqual,
			_elm_lang$core$Result$Ok(ast),
			A2(_Dandandan$parser$Parser$parse, _user$project$TimeTravel_Internal_Parser_Parser$record, s));
	});
var _user$project$Tests$testParseUnion = F2(
	function (s, ast) {
		return A2(
			_elm_community$elm_test$ElmTest$assertEqual,
			_elm_lang$core$Result$Ok(ast),
			A2(_Dandandan$parser$Parser$parse, _user$project$TimeTravel_Internal_Parser_Parser$union, s));
	});
var _user$project$Tests$testParseExpression = F2(
	function (s, ast) {
		return A2(
			_elm_community$elm_test$ElmTest$assertEqual,
			_elm_lang$core$Result$Ok(ast),
			A2(_Dandandan$parser$Parser$parse, _user$project$TimeTravel_Internal_Parser_Parser$expression, s));
	});
var _user$project$Tests$testParseStringLiteral = F2(
	function (s, ast) {
		return A2(
			_elm_community$elm_test$ElmTest$assertEqual,
			_elm_lang$core$Result$Ok(ast),
			A2(_Dandandan$parser$Parser$parse, _user$project$TimeTravel_Internal_Parser_Parser$stringLiteral, s));
	});
var _user$project$Tests$testParse = F2(
	function (s, ast) {
		return A2(
			_elm_community$elm_test$ElmTest$assertEqual,
			_elm_lang$core$Result$Ok(ast),
			_user$project$TimeTravel_Internal_Parser_Parser$parse(s));
	});
var _user$project$Tests$isOk = function (r) {
	var _p0 = r;
	if (_p0.ctor === 'Ok') {
		return true;
	} else {
...
var _user$project$Tests$testParseComplex = function (s) {
	return _elm_community$elm_test$ElmTest$assert(
		_user$project$Tests$isOk(
			_user$project$TimeTravel_Internal_Parser_Parser$parse(s)));
};
var _user$project$Tests$tests = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			'number1',
			A2(
				_user$project$Tests$testParseExpression,
				'1',
				_user$project$TimeTravel_Internal_Parser_AST$Value('1'))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'number2',
			A2(
				_user$project$Tests$testParseExpression,
				'1.2',
				_user$project$TimeTravel_Internal_Parser_AST$Value('1.2'))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'number3',
			A2(
			...
			A2(
				_user$project$Tests$testParseExpression,
				'<function:foo>',
				_user$project$TimeTravel_Internal_Parser_AST$Value(':foo'))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'stringLiteral',
			A2(
				_user$project$Tests$testParseStringLiteral,
				'\" str = { } \"',
				_user$project$TimeTravel_Internal_Parser_AST$StringLiteral(' str = { } '))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'union1',
			A2(
				_user$project$Tests$testParseUnion,
				'Tag',
				A2(
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$TimeTravel_Internal_Parser_AST$Value('1'),
							_user$project$TimeTravel_Internal_Parser_AST$StringLiteral('a')
						])))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'union4',
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									_user$project$TimeTravel_Internal_Parser_AST$Property,
									'a',
									A2(
										_user$project$TimeTravel_Internal_Parser_AST$Union,
										'Inner',
			...
			'property',
			A2(
				_user$project$Tests$testParseProperty,
				'a=1',
				A2(
					_user$project$TimeTravel_Internal_Parser_AST$Property,
					'a',
			...
			'properties',
			A2(
				_user$project$Tests$testParseProperties,
				'a=1',
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$TimeTravel_Internal_Parser_AST$Property,
						'a',
						_user$project$TimeTravel_Internal_Parser_AST$Value('2'))
					]))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'properties',
			...
			'record1',
			A2(
				_user$project$Tests$testParseRecord,
				'{}',
				_user$project$TimeTravel_Internal_Parser_AST$Record(
					_elm_lang$core$Native_List.fromArray(
						[])))),
			...
			'list1',
			A2(
				_user$project$Tests$testParseList,
				'[]',
				_user$project$TimeTravel_Internal_Parser_AST$ListLiteral(
					_elm_lang$core$Native_List.fromArray(
						[])))),
			...
			A2(
				...
				_user$project$TimeTravel_Internal_Parser_AST$ListLiteral(
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$TimeTravel_Internal_Parser_AST$StringLiteral('1'),
							_user$project$TimeTravel_Internal_Parser_AST$StringLiteral('2')
						])))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'list5',
			...
			'tuple1',
			A2(
				_user$project$Tests$testParseTuple,
				'()',
				_user$project$TimeTravel_Internal_Parser_AST$TupleLiteral(
					_elm_lang$core$Native_List.fromArray(
						[])))),
			...
			_elm_community$elm_test$ElmTest$test,
			'complex1',
			_user$project$Tests$testParseComplex('{ seed = Seed (Seed (Seed {})) }')),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'complex2',
			_user$project$Tests$testParseComplex(_user$project$Tests$complexString))
		]));
var _user$project$Tests$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_user$project$Tests$tests)
};
